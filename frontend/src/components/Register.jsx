...
export default function Register()
{
    ...
    function save(userdetails)
    {
        ...
        fetch("https://chandu-ecom-backend.herokuapp.com/register",{
            method:"POST",
    ...
    return(
        <div className="card shadow rounded m-5 p-5 mx-auto w-75">
            <h2 className="mb-4 mx-5">Register</h2>
            <form onSubmit={details.handleSubmit} className="mx-5">
                <input type="text" className="form-control" placeholder="Enter name" {...details.getFieldProps('user_name')}/>
                <span style={{color:'red'}}>
                    {details.touched.user_name && details.errors.user_name}
                </span>
